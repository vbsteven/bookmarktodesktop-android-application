	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				share.putExtra(Intent.EXTRA_TEXT, "I shared a bookmark from my Android phone to my desktop browser with #BookmarkToDesktop. http://bit.ly/a5CtSP");
				startActivity(share);
			}
		});
